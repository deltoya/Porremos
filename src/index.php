...
?>
					<tr class="<?= $class ?>">
						...
						<td class="second"><img src="images/flags/<?=$flags->getFlag($partido->getLocal())?>"/>&nbsp;<a href="#" class="tooltip2" id='<?=$partido->getId() ?>' ><?= $partido->getLocal() ?></a></td>
						<td class="second"><img src="images/flags/<?=$flags->getFlag($partido->getVisitante())?>"/>&nbsp;<a href="#" class="tooltip2" id='<?=$partido->getId() ?>' ><?= $partido->getVisitante() ?></a></td>
<?
...
$(document).ready(function(){
  ...
  $('.tooltip2').tooltip({
    folderurl : 'partidoJugado.php?id='
  });
